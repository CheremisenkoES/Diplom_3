...
class OrderFeedPage(BasePage):
    @allure.step('Тест перехода на страницу "Лента заказов"')
    ...
    @allure.step('Тест появление поп-апа с деталями')
    ...
    @allure.step('Получение номера всех заказов в "Ленте заказов"')
